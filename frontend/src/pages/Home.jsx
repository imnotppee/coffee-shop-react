...
const Home = () => {
  ...
  const recommended = [
    { img: "images/7.jpg", title: "เอสเพรสโซ่บราวน์ชูการ์", price: "฿60.00", type: "detail" },
    ...
    { img: "images/product-Honey Lemon Soda.png", title: "น้ำผึ้งมะนาวโซดา", price: "฿45.00" },
    ...
    <>
      <div className="bg-white">
        ...
        <section style={{ backgroundImage: "url('images/cof.png')", backgroundSize: 'cover', backgroundPosition: 'center', minHeight: '60vh', margin: 0, padding: 0 }} className="d-flex align-items-center text-white">
          <div className="px-4">
            <h2 className="display-1 fw-bold" style={{ color: '#FFFFFF', fontSize: '3rem' }}>
              Grown with Care, Harvested with Heart,<br /> Brewed for You
            </h2>
            <p className="lead">
              Grown with Care, Harvested with Heart, Brewed for You" means carefully grown,
              <br /> lovingly harvested, and expertly brewed just for you.
            </p>
          </div>
        </section>

        <section style={{ backgroundImage: "url('images/ni.png')", backgroundPosition: 'center', minHeight: '5vh', margin: 0, padding: 0 }} className="d-flex align-items-center text-white">
        ...
        <section style={{ backgroundImage: "url('images/cof1.png')", backgroundSize: 'cover', backgroundPosition: 'center', minHeight: '60vh', margin: 0, padding: 0 }} className="d-flex align-items-center text-white">
          <div className="px-4">
            ...
            <p className="lead">
              Our commitment to quality ensures every cup is crafted with passion and precision,
              <br /> bringing you the finest coffee experience.
            </p>
          </div>
        </section>
